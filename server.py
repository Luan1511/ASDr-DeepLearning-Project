...
# MODEL_DIR = Path("/workspace/openpose/models")
# JOB_ROOT = Path("/tmp/openpose_jobs")


# def read_openpose_json(output_dir: Path):
#     frames = []
...
# @app.post("/extract")
# async def extract_keypoints(video: UploadFile = File(...)):
...
#     input_path = job_dir / video.filename
#     output_dir = job_dir / "json"
...
app = FastAPI(
    title="ASD OpenPose + ST-GCN + Llama API",
    version="1.0.0",
)
